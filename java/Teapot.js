...
(function(){
  (function(i,s,o,g,r,a,m){i["Whatever"]=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date;
  a=s.createElement(o),m=s.getElementsByTagName(o)[0];
  a.async=1;
  a.src=g;m.parentNode.insertBefore(a,m)})(window,document,"script","test","ga");
  ...
  Teabot=function(){
    ...
    this.cup_=document.getElementById("teacup");this.offset_=null;this.tilt_=0;
  ...
  Teabot.prototype.tip_=function(e){
    ...
    if(this.offset_===null)this.offset_=tilt;tilt-=this.offset_;
    if(this.tilt_==tilt)return;
    this.tilt_=tilt;this.pour_(tilt)
  };
  Teabot.prototype.pour_=function(tilt,opt_stop){
    var tilt=Math.min(Math.max(tilt,Teabot.MAX),Teabot.MIN);
    var classNames=[];
    if(tilt<-Teabot.STEP)classNames.push("tip");
    if(tilt==Teabot.MAX)classNames.push("pour");
    ...
    if(opt_stop)window.setTimeout(this.stop_.bind(this),Teabot.WAIT);
    if(window["ga"])window["ga"]("send","event","teabot","pour","tilt",tilt)
  };
  Teabot.prototype.stop_=function(){this.pour_(0)};
  Teabot.prototype.reset_=function(){this.offset_=null;this.tilt_=0;this.stop_()};
  new Teabot;
})();
